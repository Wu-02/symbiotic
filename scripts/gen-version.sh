...
if [ "$BUILD_Z3" = "yes" ]; then
	pushd z3/build-${LLVM_VERSION}-${BUILD_TYPE} || exit 1
...
if [ "$BUILD_KLEE" = "yes" ]; then
	pushd klee/build-${LLVM_VERSION}-${BUILD_TYPE} || exit 1
